...
<body>
	...
	<div style="font-weight:bold;">
		...
		<%=articleMap.get("body")%>
		<br>
		<a href="http://localhost:8083/jspCommunity/jsp/usr/article2/doModify2?id=<%=articleMap.get("id")%>">수정</a>
		<a href="http://localhost:8083/jspCommunity/jsp/usr/article2/doDelete2?id=<%=articleMap.get("id")%>">삭제</a>
		<hr />
	</div>
	<%
	}
