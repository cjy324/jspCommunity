...
@WebServlet("/jsp/usr/article2/list2")
public class ArticleListServlet2 extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/jsp/usr/article2/list2.jsp").forward(request, response);
