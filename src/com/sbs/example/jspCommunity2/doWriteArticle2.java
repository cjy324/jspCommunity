...
@WebServlet("/jsp/usr/article2/doWrite2")
public class doWriteArticle2 extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/jsp/usr/article2/doWrite2.jsp").forward(request, response);
